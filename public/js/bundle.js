...
var displayMap = function displayMap(locations) {
  ...
  // osm layer
  var osm = L.tileLayer('https://api.maptiler.com/maps/streets-v2/{z}/{x}/{y}.png?key=ryzHUCr187ZjbijLMPbJ', {
  ...
  locations.forEach(function (location) {
    ...
    marker.bindPopup("Day ".concat(location.day, ": ").concat(location.description)).openPopup();
...
var stripe = Stripe('pk_test_51L1tQQEQ3poQqO1oE6jYqIWvrF0trwzeVMNdVqB44g58D6bCWBFLXKbZFCOemRl41smibF4UThfcAkioCdfwtwNA00bvUmVhm8');
...
// Delegation
if (mapEle) {
  var locations = JSON.parse(mapEle.dataset.locations);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4924" + '/');
